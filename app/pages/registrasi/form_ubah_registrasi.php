...
include "config.php";
$id = $_GET['id_reg'];
$queri = mysqli_query($koneksi, "SELECT * FROM registrasi where id_reg=$id");
...
<input type="text" name="id_reg" value="<?php echo
$rs['id_reg']; ?>" class="form-control">
</div>
<div class="mb-3">
...
<input type="text" name="tgl_reg" value="<?php echo
$rs['tgl_reg']; ?>" class="form-control">
</div>
<div class="mb-3">
...
<div class="mb-3">
<input type="hidden" name="id_reg" value="<?php echo
$rs['id_reg']; ?>" class="form-control">
