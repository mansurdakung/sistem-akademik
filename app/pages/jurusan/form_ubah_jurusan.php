...
include "config.php";
$id = $_GET['id_jurusan'];
$queri = mysqli_query($koneksi, "SELECT * FROM jurusan where id_jurusan=$id");
...
<h1 class="h2">Form Ubah jurusan</h1>
...
<form action="simpan_ubah_jurusan.php" method="POST">
<div class="col-6">
<div class="mb-3">
...
$rs['id_jurusan']; ?>" class="form-control">
</div>
<div class="mb-3">
...
<label for="exampleFormControlTextarea1" class="form-
label">nama_jurusan</label>

<input type="text" name="nama_jurusan" value="<?php echo
$rs['nama_jurusan']; ?>" class="form-control">
</div>
