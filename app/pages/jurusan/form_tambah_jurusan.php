...
<div class="wrapper">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card-header">
              <h3 class="card-title">frm tambah jurusan</h3>
            </div>
 ...
 <div class="col-6">
 <div class="mb-3">
 <label for="exampleFormControlInput1" class="formlabel">id_jurusan</label>
 ...
 <div class="mb-3">
 <label for="exampleFormControlTextarea1" class="formlabel">nama_jurusan</label>
