      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
           ...
           include 'config.php';
$id = $_GET['id_kalender'];
$queri = mysqli_query($koneksi, "SELECT * FROM kalender where id_kalender=$id");
...
<h1 class="h2">Form Ubah kalender</h1>
...
<form action="simpan_ubah_data_kalender.php" method="POST">
<div class="col-6">
<div class="mb-3">
...
<div class="mb-3">
<input type="hidden" name="id_kalender" value="<?php echo
$rs['id_kalender']; ?>" class="form-control">
