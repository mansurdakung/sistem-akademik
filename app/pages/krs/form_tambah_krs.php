...
<div class="wrapper">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card-header">
              <h3 class="card-title">frm tambah krs</h3>
            </div>
 ...
 <div class="col-6">
 <div class="mb-3">
 <label for="exampleFormControlInput1" class="formlabel">id_krs</label>
 <input type="text" name="id_krs" class="form-control">
 </div>
 <div class="mb-3">
 <label for="exampleFormControlTextarea1" class="formlabel">id_jadwal</label>
