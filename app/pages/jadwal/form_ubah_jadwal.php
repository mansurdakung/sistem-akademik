...
include 'config.php';
$id = $_GET['id_jadwal'];
$queri = mysqli_query($koneksi, "SELECT * FROM jadwal where id_jadwal=$id");
...
<h1 class="h2">Form Ubah jadwal</h1>
...
<form action="simpan_ubah_data_jadwal.php" method="POST">
<div class="col-6">
<div class="mb-3">
...
label">id_kalender</label>

<input type="text" name="id_kalender" value="<?php echo
$rs['id_kalender']; ?>" class="form-control">
</div>
<div class="mb-3">
...
<div class="mb-3">
<input type="hidden" name="id_jadwal" value="<?php echo
$rs['id_jadwal']; ?>" class="form-control">
